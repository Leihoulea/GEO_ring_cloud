...
def infer_stage_from_name(rel_name: str) -> str:
    ...
    if base.startswith("stage_10_") or name.startswith("stage_10_") or "/stage_10_" in name or "/stage_10_cth_validation/" in name:
        return "10"
    if base.startswith("stage_09g_") or name.startswith("stage_09g_") or "/stage_09g_" in name:
        return "09g"
...
SCRIPTS = [
    ...
    ("stage_08k_reporting/stage_08k_consolidate_report.py", "08k", "Stage 08k canonical 综合报告与 lineage manifest"),
    ("08k_consolidate_stage08_report.py", "08k", "Stage 08k 历史路径兼容入口"),
    ("stage_09/stage_09_run_epic_geo_ring_cloud_mask_diagnostics.py", "09", "Stage 09 canonical EPIC/GEO-ring 云掩膜诊断与 lineage manifest"),
    ("09_stage09_epic_georing_cloud_mask_diagnostics.py", "09", "Stage 09 历史路径兼容入口"),
...
EXT_REFS = [
    ...
    (r"D:\AAAresearch_paper\geo_ring_cloud_stage1_time_runs", "stage_08k_reporting/stage_08k_consolidate_report.py", 16, "RUNS_ROOT 多时次运行根", "D盘内"),
    (r"D:\AAAresearch_paper\geo_ring_cloud_stage1_time_runs", "stage_09/stage_09_run_epic_geo_ring_cloud_mask_diagnostics.py", 21, "RUNS_ROOT 多时次运行根", "D盘内"),
...
MODULE_REGISTRY = (
    ...
    },
    {
        ...
        "legacy_path": "",
        "migration_status": "canonical",
        "public_api": "persistent queue state, request normalization, semantic request identity, instance-unique queue IDs, conservative space estimate",
        "test_evidence": "third_report/code/geo_cloud_download/tests/test_geo_ring_cloud_transfer_batch.py::TransferBatchTests",
...
CODE_MIGRATIONS = (
    ...
    {
        "migration_id": "stage_08k_20260719_integrated_report",
        "project_id": PROJECT_ID,
        "canonical_stage_id": "stage_08k",
        "legacy_path": "third_report/code/geo_ring_cloud_stage1/08k_consolidate_stage08_report.py",
        "canonical_path": "third_report/code/geo_ring_cloud_stage1/stage_08k_reporting/stage_08k_consolidate_report.py",
        "compatibility_strategy": "legacy_path_thin_entrypoint",
        "status": "migrated_with_compatibility_entrypoint",
        "verified_by": "governance AST boundary; canonical/legacy import identity; both CLI help paths; canonical lineage manifest test",
        "rollback": "restore implementation at legacy_path and remove the canonical package only after reverting registry and tests",
        "notes": "The report builder now has a standard CLI and explicit Stage 08k lineage while preserving its historical report path.",
    },
    {
        "migration_id": "stage_09_20260719_epic_geo_ring_diagnostics",
        "project_id": PROJECT_ID,
        "canonical_stage_id": "stage_09",
        "legacy_path": "third_report/code/geo_ring_cloud_stage1/09_stage09_epic_georing_cloud_mask_diagnostics.py",
        "canonical_path": "third_report/code/geo_ring_cloud_stage1/stage_09/stage_09_run_epic_geo_ring_cloud_mask_diagnostics.py",
        "compatibility_strategy": "legacy_path_thin_entrypoint",
        "status": "migrated_with_compatibility_entrypoint",
        "verified_by": "governance AST boundary; canonical/legacy import identity; both CLI help paths; canonical lineage manifest test",
        "rollback": "restore implementation at legacy_path and remove the canonical package only after reverting registry and tests",
...
def insert_stage_registry(conn: sqlite3.Connection) -> None:
    ...
    for project_id, canonical, name, legacy, notes in [
        ...
        rows[(project_id, canonical)] = {
            ...
            "do_not_merge_with": "geo_ring_cloud.stage_09,geo_ring_cloud.stage_09b,geo_ring_cloud.stage_09c,geo_ring_cloud.stage_09d,geo_ring_cloud.stage_09e,geo_ring_cloud.stage_09f,geo_ring_cloud.stage_09g",
            "notes": notes,
        }
