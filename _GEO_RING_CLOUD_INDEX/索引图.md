...
> 历史静态快照，可能滞后于当前代码迁移。当前权威入口是 `_GEO_RING_CLOUD_WORKSPACE/README.md`、`module_registry.md`、`code_migrations.md` 与 SQLite 索引。
...
│   ├── geo_ring_cloud\evidence_pack.py    → canonical evidence-pack builder
│   ├── rebuild_stage1_evidence_pack.py    → 历史命令兼容入口
