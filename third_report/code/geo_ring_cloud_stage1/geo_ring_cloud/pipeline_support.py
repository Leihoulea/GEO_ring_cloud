...
from .diagnostics.summary import finite_stats
...
def ensure_dirs() -> None:
    """Compatibility alias for :func:`ensure_pipeline_directories`."""
    ensure_pipeline_directories()
...
__all__ = [
    "REPORT_ROOT", "GEOM_AUDIT_ROOT", "PARSED_METADATA", "VARIABLE_INVENTORY",
    "MAPPING_YAML", "STAGE_ROOT", "SCRIPT_DIR", "CONFIG_DIR", "TIME_INDEX_DIR",
    "NATIVE_DIR", "QUICKLOOK_DIR", "REPORT_DIR", "STANDARD_VARS",
    "QUICKLOOK_PRIORITY", "CATEGORICAL_VARS", "CATEGORY_FILL_VALUES",
    "CLOUD_MASK_CODE_TABLES", "CORE_PRODUCTS", "PRODUCT_MAPPING_KEYS", "UNIT_TARGETS",
    "ReadResult", "ensure_dirs", "utc_now", "normalize_name", "safe_name", "parse_time",
    "iso_z", "read_mapping", "product_mapping_key", "resolve_variable_names",
    ...
    "convert_units", "mask_sentinel_values", "array_valid_mask", "add_valid_and_quality",
    "read_netcdf_product", "read_hdf_product", "read_meteosat_zip",
    "reshape_square_if_needed", "read_product", "finite_stats", "make_quicklook",
    "write_json_npz", "cloud_mask_semantics", "cloud_mask_masks", "cloud_mask_rows",
    "reproject_mask_for_use",
]
