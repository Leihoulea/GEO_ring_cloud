...
def write_code_reuse_audit(out_root: Path) -> None:
    rows = [
        ...
        {"functionality": "Stage 09 summary", "existing_script_path": str(CODE_ROOT / "09_stage09_epic_georing_cloud_mask_diagnostics.py"), "existing_function_or_class": "main", "can_reuse_directly": "yes", "needs_wrapper": "yes", "risk": "low", "notes": "Can be rerun after new samples; 09B keeps separate outputs."},
    ]
