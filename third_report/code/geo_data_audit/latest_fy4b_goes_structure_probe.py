...
OUT_DIR = DATA_CHECK_ROOT / "latest_fy4b_goes_structure_probe"
FY4B_GEO_ROOT = DATA_ROOT / "FY4B-GEO"
FY4B_CTP_ROOT = DATA_ROOT / "FY4B-CTP"
GOES_ROOT = EXTERNAL_GEO_CLOUD_ROOT
...
def summarize(file_rows: list[dict[str, Any]], var_rows: list[dict[str, Any]], anomalies: list[dict[str, Any]]) -> str:
    ...
    lines = [
        ...
        "",
        f"Scope: newly supplied FY4B GEO/CTP roots plus GOES cloud products currently under {GOES_ROOT}. This probe reads first/middle/last samples per satellite/product and does not modify source data.",
        "",
        "## File Counts",
        "",
