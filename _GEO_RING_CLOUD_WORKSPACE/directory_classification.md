...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| D:\AAAresearch_paper\data | 强相关 | 原始卫星数据（FY4A/FY4B L1 + FY4B 云产品 CLM/CLP/CLT/CTH/CTP/CTT/GEO + H09_Data） | 4769 | 102.5 GB | 是 | 是 | 否 | keep_in_place | geo_ring_cloud.paths.HIMAWARI_R21_DIR；06f 扫描 data/ |
...
| D:\AAAresearch_paper\third_report\code\geo_cloud_download | 上游相关 | GEO 云产品下载器（EUMETSAT API + S3） | 37 | 503.4 KB | 间接 | 是 | 否 | keep_in_place | 下载原始云产品到 data/ 与 E 盘 |
